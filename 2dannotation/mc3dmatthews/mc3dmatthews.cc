...
MC3DMatthews::MC3DMatthews(int argc, char * argv [])
: mfAppVersion(1.0f),
mstrAppName("MC3DMatthews")
{
...
void MC3DMatthews::version () const
{
...
void MC3DMatthews::read_options (int argc, char* argv[])
{
	int c;
...
void MC3DMatthews::readHypotheticalInteractionsFile()
{
...
void MC3DMatthews::displayHypothesis() const
{
