...
void T2TableBuilder::computeTable()
{
...
void T2TableBuilder::readPDBGroups(const std::string& astrGroupFile)
{
	// Read the file
...
unsigned int T2TableBuilder::profileId(const std::string& astrProfile) const
{
...
void T2TableBuilder::readInteractions(const std::string& astrInteractionsFile)
{
	std::ifstream infile;
...
annotate::BasePair::enOrientation T2TableBuilder::getOrientation(
...
annotate::InteractionInfo::enFace T2TableBuilder::getFace(
...
annotate::CycleInfo T2TableBuilder::getCycleInfo(
...
annotate::CycleInfo::residue_strand T2TableBuilder::getResIds(
...
unsigned int T2TableBuilder::profileId(const annotate::CycleInfo& aCycle) const
{
	std::string strProfile = aCycle.getProfile().toString();
	return profileId(strProfile);
}

unsigned int T2TableBuilder::interactionTypeId(const annotate::InteractionInfo& aInteraction) const
{
...
unsigned int T2TableBuilder::flipInteractionTypeId(const annotate::InteractionInfo& aInteraction) const
{
...
std::string T2TableBuilder::profileString(unsigned int auiProfile) const
{
...
std::string T2TableBuilder::interactionTypeString(unsigned int auiTypeId) const
{
	const char* szTypes[] = {
